...
simulated function BuildConditionTrainingCompleteAlert(string TitleLabel)
{
	...
	// AbilityName = class'X2TacticalGameRulesetDataStructures'.default.m_aCharStatLabels[default.Stat] @class'UIChooseClass_ConditionSoldier'.default.m_strStatTitle;
